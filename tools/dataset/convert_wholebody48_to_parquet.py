#!/usr/bin/env python3
"""Convert wholebody48 COCO JSON annotations to image-row Parquet files."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert wholebody48 COCO JSON files to Parquet with embedded image bytes.'
    )
    parser.add_argument(
        '--dataset-root',
        type=Path,
        default=Path('tools/dataset/wholebody48'),
