"""
PyTorch checkpoint demo for DEIMv2 wholebody68 instance segmentation.
"""
...
BODY_CLASS_ID = 0
DEFAULT_CONFIG = 'configs/deimv2/deimv2_dinov3_x_wholebody68_ins_s08_maskhead256x3_center.yml'
...
EDGES = [
    ...
    (39, 42), (39, 42),
    (42, 45), (42, 45),
    (29, 48), (48, 49), (49, 50), (50, 51),
    (29, 52), (52, 53), (53, 54), (54, 55),
    (29, 56), (56, 57), (57, 58), (58, 59),
    (29, 60), (60, 61), (61, 62), (62, 63),
    (29, 64), (64, 65), (65, 66), (66, 67),
]
...
HAND_KEYPOINT_CLASS_IDS = set(range(48, 68))
...
KEYPOINT_NMS_CLASS_IDS = KEYPOINT_CLASS_ID_ORDER + tuple(range(48, 68))
...
def process_images(args) -> None:
    ...
    try:
        while True:
            ...
            cv2.imshow('DEIMv2 WholeBody68', debug_image)
