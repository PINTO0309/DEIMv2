"""
PyTorch checkpoint demo for DEIMv2 wholebody48 instance segmentation.
"""
...
BODY_CLASS_ID = 0
DEFAULT_CONFIG = 'configs/deimv2/deimv2_dinov3_x_wholebody48_ins_s08_maskhead256x3_center.yml'
...
def process_images(args) -> None:
    ...
    try:
        while True:
            ...
            cv2.imshow('DEIMv2 WholeBody48', debug_image)
